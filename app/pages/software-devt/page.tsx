...
import { getUserCountryCode } from "@/lib/getUserCountry"; // ADDED IMPORT
import { countryPricing, defaultPricing } from "@/lib/countryPricing"; // ADDED IMPORT
...
export default function Page() {
  ...
  const [paymentInfo, setPaymentInfo] = useState({ // ADDED STATE
    amount: defaultPricing.amount,
    currency: defaultPricing.currency,
  });

  // ADDED useEffect FOR DYNAMIC PRICING
  useEffect(() => {
  ...
  const fetchLectureDetails = useCallback(async () => {
    try {
      ...
      const response = await axios.get("/api/live-courses/software-devt/lecture");
        ...
        <div className="mt-4">
          {lecture.hasAccess ? (
            <div>
              ...
              <Link 
                href="https://chat.whatsapp.com/HGKeNUGuRVjJB8vbmjkVC3"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="inline-block">
              <FlutterwavePayment 
                ...
                onSuccess={() => {
                  ...
                  router.push("/software-devt/success");
                }}
                onError={(error) => {
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to the Software Development Course"
        />
      </Head>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl mb-8">
                Master the Art of Software Development! Learn to build robust,
                scalable applications from the ground up. From frontend to backend,
                databases to APIs, you will develop the skills to create complete
                software solutions that solve real-world problems.
              </p>
            </div>
            <div className="relative h-96 rounded-2xl overflow-hidden shadow-xl">
              <Image
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfXeljsQQ9ezIVI7ekGLthBUBdxZ9ZmKkQFA&s"
        ...
        <div className="flex-1 text-black">
          ...
          <div className="font-semibold">
            ...
            <h2 className="text-2xl font-bold mb-2 mt-6">
              Software Development Virtual (Start Date: Sat 17th-May-2025)
            </h2>
