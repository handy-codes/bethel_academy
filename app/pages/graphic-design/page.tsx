  ...
  const fetchLectureDetails = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        "/api/live-courses/graphic-design/lecture"
      );
          ...
          {lecture.hasAccess ? (
            <div>
              ...
              <p className="mb-4 my-4">
                ...
                <Link
                  href="https://chat.whatsapp.com/Gm9GZmApwRaGhaJ4HMBrno"
                  target="_blank"
            ...
            <div className="inline-block">
              <FlutterwavePayment
                ...
                onSuccess={() => {
                  ...
                  router.push("/graphic-design/success");
                }}
                onError={(error) => {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl mb-8">
                Master the Art of Graphic Design! Learn to create stunning
                visuals that capture attention and convey messages effectively.
                From branding to typography, layout to color theory, you will
                develop the skills to create professional designs that make an
                impact.
              </p>
            </div>
      ...
      <section className="container mx-auto p-4 mt-4 flex flex-col md:flex-row gap-8">
        <div className="flex-1 text-black">
          ...
          <p className="text-justify font-semibold max-sm:mb-1">
            ...
            branding to digital illustration. Learn from industry experts who
            have created iconic designs for global brands. Join a community of
            designers passionate about creating impactful visual solutions. Dive
            into design principles, software mastery, and creative thinking
            while earning certifications that showcase your expertise. Ready to
            become a graphic design professional? Enroll now and start
            creating—one design at a time. 🎨✨🚀
          </p>
          ...
          <div className="font-semibold">
            ...
            <h2 className="text-2xl font-bold mb-2 mt-6">
              Graphic Design Virtual Class (Start Date: Thurs 15th-May-2025)
            </h2>
