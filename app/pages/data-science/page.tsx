        ...
        {lecture.lectures && lecture.lectures.length > 0 ? (
          ...
          {lecture.hasAccess ? (
            <div>
              ...
              <Link 
                href="https://chat.whatsapp.com/Cq0psIwzoGf9Gu7Lk83cXI"
                target="_blank"
                rel="noopener noreferrer"
      ...
      <section className="container mx-auto p-4 mt-4 flex flex-col md:flex-row gap-8">
        <div className="flex-1 text-black">
          ...
          <p className="text-justify font-semibold max-sm:mb-1">
            Techxos powers your rise: Master the art of data analysis, machine
            learning, and statistical modeling. Learn from industry experts who have
            transformed businesses through data-driven insights. Join a community of
            data scientists passionate about solving complex problems. Dive into
            Python, R, SQL, and advanced analytics while earning certifications
            that showcase your expertise. Ready to become a data-driven decision
            maker? Enroll now and start transforming data into value—one insight at
            a time. 📊🔍🚀
          </p>
          ...
          <div className="font-semibold">
            ...
            <h2 className="text-2xl font-bold mb-2 mt-6">
              Data Science Virtual (Start Date: Thurs 15th-May-2025)
            </h2>
