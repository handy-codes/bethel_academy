        ...
        <div className="mt-4">
          {lecture.hasAccess ? (
            <div>
              ...
              <Link 
                href="https://chat.whatsapp.com/CiyJWT5HJH61vJjduAxFO3"
                target="_blank"
                rel="noopener noreferrer"
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to the AI & Machine Learning course page. Learn about artificial intelligence, machine learning, and deep learning concepts."
        />
      </Head>
        ...
        <div className="flex-1 text-black">
          ...
          <div className="font-semibold">
            ...
            <h2 className="text-2xl font-bold mb-2 mt-6">
              AI & Machine Learning Virtual (Start Date: Tues 13th-May-2025)
            </h2>
