  ...
  const fetchLectureDetails = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        "/api/live-courses/cybersecurity/lecture"
      );
          ...
          {lecture.hasAccess ? (
            <div>
              ...
              <p className="mb-4 my-4">
                ...
                <Link
                  href="https://chat.whatsapp.com/KMVlNzWH8D9CVMbznsIQXv"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="inline-block">
              <FlutterwavePayment
                ...
                onSuccess={() => {
                  ...
                  router.push("/cybersecurity/success");
                }}
                onError={(error) => {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl mb-8">
                Defend the Digital Frontier with Cybersecurity! Imagine being
                the guardian of digital assets, protecting systems from
                sophisticated threats, and outsmarting cybercriminals at their
                own game. Cybersecurity is the art of defending networks,
                systems, and programs from digital attacks—and it is more
                critical than ever in our connected world.
              </p>
            </div>
      ...
      <section className="container mx-auto p-4 mt-4 flex flex-col md:flex-row gap-8">
        <div className="flex-1 text-black">
          ...
          <h1 className="text-3xl text-green-800 lg:text-4xl font-extrabold mb-4 md:mb-2 lg:mb-6">
            {paymentInfo.amount.toLocaleString()} {paymentInfo.currency} {/* UPDATED */}
          </h1>
          <p className="text-justify font-semibold max-sm:mb-1">
            Techxos powers your rise: Simulate real-world cyber attacks (think
            penetration testing or incident response), learn from industry pros
            who have foiled cybercrime rings, and join a network of defenders
            obsessed with keeping data safe. Dive into ethical hacking, network
            security, and threat intelligence, while earning certifications that
            scream, hire me. Ready to become a digital guardian? Enroll now and
            start defending the future—one firewall at a time. 🛡️🔒🚀
          </p>
          ...
          <div className="font-semibold">
            ...
            <h2 className="text-2xl font-bold mb-2 mt-6">
              Cybersecurity Virtual Class (Start Date: Tues: 13th-May-2025)
            </h2>
