...
const NewsMarquee = () => {
  ...
  const newsText = " ✅The Bethel Academy mock exam results are out.  Hurry now to pick yours.";
  ...
  return (
    ...
    <div className="w-full bg-[#00468D] md:py-2 text-primary-foreground overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-0 flex flex-col md:flex-row md:justify-between items-center py-1 ">
        {user && (
