...
export default function ExamPage({ params }: { params: { id: string } }) {
  ...
  // Resolve student id (Clerk user id if available, else stable anon id)
  useEffect(() => {
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className={`flex items-center space-x-2 px-3 py-2 rounded-lg ${timeLeft < 300 ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'
                }`}>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-6">
                ...
                <div className="space-y-4">
                  {['A', 'B', 'C', 'D', 'E'].map((option) => (
                    <label
                      key={option}
                      className={`flex items-center space-x-3 p-4 rounded-lg border-2 cursor-pointer transition-colors ${answers[currentQuestion.id] === option
