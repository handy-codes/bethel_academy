...
export default function LiveClassesPage() {
  ...
  const handleDelete = async (classId: string) => {
    try {
      ...
      await axios.delete(`/api/admin/live-classes/${classId}`);
              ...
              <TableRow key={liveClass.id}>
                ...
                <TableCell>
                  <div className="flex gap-2">
                    <Link href={`/admin/live-classes/edit/${liveClass.id}`}>
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        ...
                        >
                          {isDeleting === liveClass.id ? "Deleting..." : "Delete"}
                        </Button>
                      </AlertDialogTrigger>
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            &quot;{liveClass.title}&quot; and all associated data.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
