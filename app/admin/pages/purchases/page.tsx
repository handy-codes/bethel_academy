...
export default function PurchasesPage() {
  ...
  const revenueByCurrency = purchases.reduce((acc, purchase) => {
  ...
  const formattedRevenue = Object.entries(revenueByCurrency).map(
    ([currency, amount]) => {
      let formatted;
      try {
              ...
              {mostRecentPurchase ? (
                <div className="text-sm">
                  <div className="font-medium">
                    {mostRecentPurchase.student?.name || "Unknown"}
                  </div>
                  <div className="text-xs text-muted-foreground">
                    {format(
                      parseISO(mostRecentPurchase.createdAt),
                      "MMM dd, yyyy"
                    )}
                  </div>
                </div>
