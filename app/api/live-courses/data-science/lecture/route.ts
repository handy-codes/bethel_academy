...
export async function GET(req: Request) {
  try {
    ...
    if (!liveClass) {
      console.log("[LECTURE_GET] Data Science course not found, creating it");
      try {
        ...
        liveClass = await db.liveClass.create({
          data: {
            title: "Data Science",
            description: "Lead the Charge to Success with Data Science! Master project planning, execution, and delivery.",
            startTime: now,
            endTime: endDate,
        ...
        console.log("[LECTURE_GET] Created Data Science course with price:", liveClass.price);
