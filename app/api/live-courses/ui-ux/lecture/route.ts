...
export async function GET(req: Request) {
  try {
    ...
    if (!liveClass) {
      console.log("[LECTURE_GET] UI-UX Design course not found, creating it");
      try {
        ...
        liveClass = await db.liveClass.create({
          data: {
            title: "UI-UX Design",
            description: "Lead the Charge to Success with UI-UX Design! Master project planning, execution, and delivery.",
            startTime: now,
            endTime: endDate,
        ...
        console.log("[LECTURE_GET] Created UI-UX Design course with price:", liveClass.price);
