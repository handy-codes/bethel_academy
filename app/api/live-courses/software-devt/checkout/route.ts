...
export async function POST(req: Request) {
  try {
    ...
    // Find the Software Development course
    ...
    if (existingPurchase) {
      ...
      return NextResponse.json({
        ...
        redirect_url: `${process.env.NEXT_PUBLIC_APP_URL}/pages/software-devt/success`,
    ...
    const redirectUrl = "/pages/software-devt/success";
