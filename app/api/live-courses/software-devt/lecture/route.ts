...
export async function GET(req: Request) {
  try {
    ...
    if (!liveClass) {
      console.log("[LECTURE_GET] Software Development course not found, creating it");
      try {
        ...
        liveClass = await db.liveClass.create({
          data: {
            title: "Software Development",
            description: "Lead the Charge to Success with Software Development! Master project planning, execution, and delivery.",
            startTime: now,
            endTime: endDate,
        ...
        console.log("[LECTURE_GET] Created Software Development course with price:", liveClass.price);
