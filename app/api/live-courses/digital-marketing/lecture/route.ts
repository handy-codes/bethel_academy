...
export async function GET(req: Request) {
  try {
    ...
    if (!liveClass) {
      console.log("[LECTURE_GET] Digital Marketing course not found, creating it");
      try {
        ...
        liveClass = await db.liveClass.create({
          data: {
            title: "Digital Marketing",
            description: "Lead the Charge to Success with Digital Marketing! Master project planning, execution, and delivery.",
            startTime: now,
            endTime: endDate,
        ...
        console.log("[LECTURE_GET] Created Digital Marketing course with price:", liveClass.price);
