...
export async function GET(req: Request) {
  try {
    ...
    if (!liveClass) {
      console.log("[LECTURE_GET] Fullstack Development course not found, creating it");
      try {
        ...
        liveClass = await db.liveClass.create({
          data: {
            title: "Fullstack Development",
            description: "Lead the Charge to Success with Fullstack Development! Master project planning, execution, and delivery.",
            startTime: now,
            endTime: endDate,
        ...
        console.log("[LECTURE_GET] Created Fullstack Development course with price:", liveClass.price);
