...
export async function GET(req: Request) {
  try {
    ...
    if (!liveClass) {
      console.log("[LECTURE_GET] Graphic Design course not found, creating it");
      try {
        ...
        liveClass = await db.liveClass.create({
          data: {
            title: "Graphic Design",
            description: "Lead the Charge to Success with Graphic Design! Master project planning, execution, and delivery.",
            startTime: now,
            endTime: endDate,
        ...
        console.log("[LECTURE_GET] Created Graphic Design course with price:", liveClass.price);
