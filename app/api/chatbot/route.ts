...
const FALLBACK_COURSES: Course[] = [
  ...
  },
  {
    ...
    description: "User interface with experience design"
  },
  {
...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemMessage = {
      ...
      - Next cohort starts: 12 May 2025
      ...
      **Contact Information**:
      ...
      7. For any information not in the provided data:
         - Direct users to hello@techxos.com
         - Never say "I don't know" or "I'm an AI"
         - Instead say "For detailed information about this, please contact our sales team at hello@techxos.com"
