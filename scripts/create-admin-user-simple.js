...
async function createAdminUser(email, role = 'admin') {
  try {
    ...
    console.log(`   Authentication: Google OAuth + Password`);
    ...
    console.log('4. Click "Continue with Google" OR use email/password');
    ...
    console.log(`   - Email/Password: Use ${email} / TempSecurePass2024!@#`);
...
if (args.length === 0) {
  console.log('Usage: node scripts/create-admin-user-simple.js <email> [role]');
  console.log('');
  console.log('Examples:');
  console.log('  node scripts/create-admin-user-simple.js paxymek@gmail.com ADMIN');
  console.log('  node scripts/create-admin-user-simple.js john.doe@student.com STUDENT');
  console.log('  node scripts/create-admin-user-simple.js jane.smith@lecturer.com LECTURER');
  console.log('');
