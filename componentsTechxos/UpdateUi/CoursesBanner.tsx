        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">
              Online & On-campus Modules
            </h1>
            <p className="text-xl mb-8">
              Check out our well-curated courses below that you can enroll for, online or in-person. In our cozy training environment, we guide you hands-on, every step of the way, to ensure you get the best out of your learning experience.
              Going virtual? We&apos;ve got you covered too with our Live Share extensions and streaming tools for realtime engagement!!
            </p>
          </div>
        </div>
      </div>
